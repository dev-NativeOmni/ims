...
class MurajaahRecordResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'tajwid_score' => $this->tajwid_score,
            'makhraj_score' => $this->makhraj_score,
            ...
            'notes' => $this->notes,
            'reviewed_at' => optional($this->reviewed_at)->format('Y-m-d'),
