    ...
    <x-slot name="header">
        <div class="flex flex-col gap-1">
            ...
            <p class="text-sm text-gray-600 dark:text-zinc-400">
                Ubah informasi catatan poin kedisiplinan murid.
            </p>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-zinc-900 rounded-2xl border border-gray-200 dark:border-zinc-800 shadow-sm overflow-hidden transition-colors duration-200">
                ...
                <form method="POST" action="{{ route('student-points.update', $studentPoint) }}" class="p-6 space-y-6" x-data="{
                    type: '{{ old('type', $studentPoint->type) }}',
                    selectedClass: '',
                    selectedStudent: '{{ old('student_id', $studentPoint->student_id) }}',
                    allStudents: [
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            >
                                ...
                                <option value="lateness" {{ old('type', $studentPoint->type) === 'lateness' ? 'selected' : '' }}>Pelanggaran Keterlambatan</option>
                                <option value="attribute" {{ old('type', $studentPoint->type) === 'attribute' ? 'selected' : '' }}>Pelanggaran Atribut/Seragam</option>
