                ...
                <form method="POST" action="{{ route('programs.update', $program) }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            required
                        >
                            <option value="setiap hari" @selected(old('meeting_frequency', $program->meeting_frequency) === 'setiap hari')>Setiap Hari</option>
                            <option value="seminggu sekali" @selected(old('meeting_frequency', $program->meeting_frequency) === 'seminggu sekali')>Seminggu Sekali</option>
                        </select>
