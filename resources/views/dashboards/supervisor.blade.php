    ...
    <div class="py-8">
        <div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-3">
                ...
                <!-- Total Murid -->
                <div class="rounded-2xl bg-white dark:bg-zinc-900 p-6 shadow-md hover:shadow-lg transition-shadow duration-200 flex items-center gap-4">
            ...
            <!-- Progress Bar Besar -->
            <div class="bg-white dark:bg-zinc-900 shadow-md rounded-2xl p-6">
