    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                <a href="{{ url('/hafalan-records/create') }}" class="bg-white dark:bg-zinc-900 shadow-md rounded-2xl p-5 hover:shadow-lg hover:scale-[1.01] transition-all duration-200 flex items-center gap-4 group">
                ...
                <a href="{{ url('/hafalan-targets/create') }}" class="bg-white dark:bg-zinc-900 shadow-md rounded-2xl p-5 hover:shadow-lg hover:scale-[1.01] transition-all duration-200 flex items-center gap-4 group">
