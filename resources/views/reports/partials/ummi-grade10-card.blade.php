<div id="ummiGrade10ReportCard" class="mx-auto max-w-5xl rounded-[28px] p-5 sm:p-8 shadow-2xl relative overflow-hidden font-sans border-[5px] border-amber-400" style="background-color: #ffffff !important; color: #0f172a !important;">
    ...
    <div class="flex items-center justify-center gap-3 sm:gap-5 border-b-2 border-amber-300 pb-3 mb-3">
        <!-- Logo Bulat (Left) -->
        <img src="{{ asset('images/logo-alazhar7-circle.png') }}" alt="Logo Al Azhar 7" class="w-12 h-12 sm:w-16 sm:h-16 object-contain shrink-0">

        <!-- Logo Gemilang (Right of Logo Bulat) -->
        <img src="{{ asset('images/logo-gemilang-banner.png') }}" alt="SMA Islam Al Azhar 7 GEMILANG" class="h-9 sm:h-12 object-contain shrink-0">
    </div>
