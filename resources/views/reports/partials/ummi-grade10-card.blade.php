<div id="ummiGrade10ReportCard" class="mx-auto max-w-4xl rounded-[32px] p-6 sm:p-10 shadow-2xl relative overflow-hidden font-sans border-[6px] border-amber-400" style="background-color: #ffffff !important; color: #0f172a !important;">
    ...
    <div class="flex items-center justify-center gap-4 sm:gap-6 border-b-2 border-amber-300 pb-5 mb-6">
        <!-- Logo Bulat (Left) -->
        <img src="{{ asset('images/logo-alazhar7-circle.png') }}" alt="Logo Al Azhar 7" class="w-16 h-16 sm:w-20 sm:h-20 object-contain shrink-0">

        <!-- Logo Gemilang (Right of Logo Bulat) -->
        <img src="{{ asset('images/logo-gemilang-banner.png') }}" alt="SMA Islam Al Azhar 7 GEMILANG" class="h-10 sm:h-14 object-contain shrink-0">
    </div>
